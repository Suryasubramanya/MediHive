               ...
               <Container >
                  <div className="contact_lab">
                      <div className="contact_pic">
                        ...
                        <img src="https://www.MediHive.com/tests/public/images/call_to_order.svg" alt="" />
                      ...
                      <div className="contact_num">
                          ...
                          <div>
                         <img src = "https://www.MediHive.com/tests/public/icons/call-to-order.svg" alt="" />
                         </div>
                           <h4>+91 8045684087</h4> 
                      </div>
                 </div> 
                   ...
                   <div className="test_medical">
                      <div className="tests">
                          ...
                          <div className="flex">
                              ...
                              <img src="https://www.MediHive.com/tests/public/icons/testprofiles/lipid_profile.png"/>
                             <h5>Lipid Profile</h5>
                             </div>
                      ...
                      <div className="flex">
                              ...
                              <img src="https://www.MediHive.com/tests/public/icons/testprofiles/liver_profile.png"/>
                             <h5>Liver Profile</h5>
                      ...
                      <div className="flex">
                              ...
                              <img src="https://www.MediHive.com/tests/public/icons/testprofiles/blood_sugar.png"/>
                             <h5>Blood Sugar</h5>
              ...
              <br />
               ...
               <div>
                   ...
                   <div className="written_flex">
                       ...
                       <div className="small_line"></div>
                       <p>We will email you the reports. You can also access your reports within your account on the MediHive app</p>
                   </div>
                   <br />
               </div>
               </Container>
               ...
               <div className="back_grey">
                   ...
                   <div className="great_flex">
                       <div>
                           <img src="https://www.MediHive.com/tests/public/icons/dogreat/user.png?1563954988" />
                          <br />
                           <h3>15 Million users every month</h3>
                       </div>
                       <div> 
                           <img src="https://www.MediHive.com/tests/public/icons/dogreat/briefcase.png?1563954997" />
                           <br />
                           <h3>Trusted by 2,00,000 professionals</h3>
                           </div>
                       <div> 
                           <img src="https://www.MediHive.com/tests/public/icons/dogreat/location.png?1563955004" />
               ...
               <Container className="h3">
                   ...
                   <Carousel  interval={2000}>
                      ...
                      <br />
                       ...
                       <Carousel.Item>
                           <h3>"Good service, MediHive is avoiding to stand in que for health checkups</h3>
               ...
               <Container>
                  <div className="last_div">
                   <p>Book <strong>Diagnostic tests</strong> near you with MediHive Associate Labs, your online lab test service provider for diagnostic, medical tests and health checkup packages</p>
                   <p>Get all the benefits of <strong>diagnostic centre</strong> and <strong>pathology labs</strong> right from the comfort of your home. With a phlebotomy team to ensure speedy home sample collection, and diagnostic services ranging from individual tests to complete health checkup packages for Men, Women, Senior Citizens & Corporates. MediHive Associate Labs takes care of all your diagnostic needs.
</p>
                   <p><strong>Wide Selection of Tests:</strong>Wide Selection of Tests: MediHive Associate Labs covers a wide array of tests like <strong>blood sugar tests, thyroid tests, pregnancy tests, allergy tests, lipid profile, liver profile, platelet count, VDRL test, vitamin B12 deficiency test and more</strong>. Get details of all these tests such as blood test cost, when to take the tests, why it is required, who should take the test and what to do before taking the blood tests at home.</p>
                   <p><strong>Sample Collection at Home:</strong>Sample Collection at Home: Book blood tests online from your home and our expert team of MediHive Associate Labs technicians will arrive at the pre-scheduled time to pick up your sample. Once you get a diagnostic test done, you will receive your reports online.</p>
