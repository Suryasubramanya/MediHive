    ...
    return (
        <div>
            ...
            <Container className="last_order_p">
                ...
                <p>Find and buy medicines online with MediHive Pharmacy. Browse through prescription medicines, OTC products, health & wellness products on an online pharmacy that provides hassle free service across 100+ cities in India With an extensive catalogue of medicines and healthcare products provided on an extensive and easy to navigate destination for online medicine shopping, MediHive Pharmacy provides added advantages which include:</p>
